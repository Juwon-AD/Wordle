CREATE OR REPLACE PACKAGE WORDLES IS
  ...
  V_USERNAME BANKSYS.WORDLE_LOG.OS_USER%TYPE := TRIM(SYS_CONTEXT('USERENV',
                                                                 'OS_USER'));
  V_IP       BANKSYS.WORDLE_LOG.IP_ADDRESS%TYPE := TRIM(SYS_CONTEXT('USERENV',
                                                                    'IP_ADDRESS'));
  ...
  PROCEDURE WORDLE_3(GUESS_1  IN CHAR,
                     ...
                     WORD_2   OUT CHAR,
                     WORD_3   OUT CHAR,
                     RESPONSE OUT BANKSYS.WORDLE_LOG.RESPONSE%TYPE);
...
CREATE OR REPLACE PACKAGE BODY WORDLES IS
  ...
  PROCEDURE INSERT_WORDLE_LOG(RESP   IN BANKSYS.WORDLE_LOG.RESPONSE%TYPE,
                              V_TYPE NUMBER) IS
  ...
  PROCEDURE WORDLE_3(GUESS_1  IN CHAR,
                     ...
                     WORD_2   OUT CHAR,
                     WORD_3   OUT CHAR,
                     RESPONSE OUT BANKSYS.WORDLE_LOG.RESPONSE%TYPE) AS
